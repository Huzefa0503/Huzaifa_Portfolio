...
function toggleAdditionalSkills() {
    const additionalSkills = document.querySelector('.additional-skills-grid');
    ...
    if (additionalSkills.style.display === 'none') {
        ...
        toggleBtn.innerHTML = 'Show Less <i class="feather-chevron-up"></i>';
    } else {
        additionalSkills.style.display = 'none';
        icon.classList.remove('feather-chevron-up');
        icon.classList.add('feather-chevron-down');
        toggleBtn.innerHTML = 'View All Skills <i class="feather-chevron-down"></i>';
    }
}
